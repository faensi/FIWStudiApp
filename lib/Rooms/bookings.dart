...
class RadioWidgetDemo extends StatefulWidget {
  ...
  RadioWidgetDemo(Future<List<Booking>> bookings,  List<Booking> bookingDetails){
      ...
      FutureBuilder(
        ...
        builder: (context, projectSnap) {
          return ListView.builder(
            itemCount: RadioWidgetDemo.bookingDetails == null ? 0 : RadioWidgetDemo.bookingDetails.length,
            itemBuilder: (context, index) {
              return Card(
                child: ListTile(
                  title: Text(RadioWidgetDemo.bookingDetails[index].description + "\n",
                      textAlign: TextAlign.center,
                      style: TextStyle(fontSize: 25.0, color: Colors.black)),
                  subtitle: Text(RadioWidgetDemo.bookingDetails[index].description))
                  );
            },
          );
        },
